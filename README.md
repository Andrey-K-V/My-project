...
## ОРеализация базы данных ТМЦ (РеализацияБазыДанныхТМЦ.dt)
Необходимо реализовать базу данных учета ТМЦ.
База данных состоит из объектов метаданных:

<img width="630" alt="СтруктураБД" src="https://github.com/user-attachments/assets/32354efc-22a6-4c2e-a36c-d2d44b0d6f94" />
...
- 
<img width="630" alt="Отчет" src="https://github.com/user-attachments/assets/415b78d6-5b8b-49a3-a592-009d4c9d53fd" />
